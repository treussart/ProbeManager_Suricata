...
class SuricataTest(TestCase):
    ...
    def test_suricata(self):
        ...
        self.assertEqual(suricata.ansible_become_method, "sudo")
        self.assertEqual(suricata.ansible_become_user, "root")
        self.assertEqual(decrypt(suricata.ansible_become_pass), b'?gyEdOHFbFCGL&z7.1X@')
        self.assertTrue(suricata.ansible_become)
